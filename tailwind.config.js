  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        image1:
          'linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.4)) ,url("./public/image1.jpg")',
        image2: 'url("./public/image2.jpg")',
        image3: 'url("./public/image3.jpg")',
        image4: 'linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.4)), url("./public/image4.jpg")',
        image5: 'url("./public/image5.jpg")',
        image6: 'url("./public/image6.jpg")',
        image7: 'url("./public/image7.jpg")',
        image8: 'url("./public/image8.jpg")',
        image9:
          'linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.4)), url("./public/image9.jpg")',
        image10: 'linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.4)), url("./public/image10.jpg")',
